...
public class PastHistoryOperationListAdapter extends ArrayListAdapter<PastHistoryOperation> {
	private List<PastHistoryOperation> mList;
	private PastHistoryListItemClickHelp callback;
	public PastHistoryOperationListAdapter(Context context, List<PastHistoryOperation> list,PastHistoryListItemClickHelp callback) {
		super(context, list);
		mList = list;
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		holder.update.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				callback.onClickOperation(view, parent, p, one);
			}
		});
		holder.delete.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				callback.onClickOperation(view, parent, p, two);
			}
		});
		return convertView;
	}
