...
public class PastHistoryDiseaseListAdapter extends ArrayListAdapter<PastHistoryDisease> {
	private List<PastHistoryDisease> mList;
	private PastHistoryListItemClickHelp callback;
	public PastHistoryDiseaseListAdapter(Context context, List<PastHistoryDisease> list,PastHistoryListItemClickHelp callback) {
		super(context, list);
		mList = list;
	...
	public View getView(int position, View convertView, final ViewGroup parent) {
		...
		holder.update.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				callback.onClickDisease(view, parent, p, one);
			}
		});
		holder.delete.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				callback.onClickDisease(view, parent, p, two);
			}
		});
		return convertView;
	}
