...
public class CerebralApoplexyBody2 extends LinearLayout  implements IBaseCerebralApoplexyBody{
	...
	public CerebralApoplexyBody2(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		View rootView = LayoutInflater.from(context).inflate(R.layout.view_cerebral_apoplexy_body2, this, true);
	...
	public void getData(FollowUpStroke followUpStroke) {
		...
		followUpStroke.setShxggb_sfyjms(et_bhj.getText().toString()+"/"+et_pj.getText().toString());
