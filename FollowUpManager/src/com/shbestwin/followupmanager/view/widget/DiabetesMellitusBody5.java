...
public class DiabetesMellitusBody5 extends LinearLayout implements
    ...
    public DiabetesMellitusBody5(Context context, AttributeSet attrs,
        ...
        View rootView = LayoutInflater.from(context).inflate(
                R.layout.view_diabetes_mellitus_body5, this, true);
    ...
    public void getData(FollowUpDiabetesMellitus followUpDiabetesMellitus) {
        try {
            followUpDiabetesMellitus.setYyqk(JsonUtil
