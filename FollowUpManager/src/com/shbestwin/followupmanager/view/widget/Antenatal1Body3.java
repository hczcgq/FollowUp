...
public class Antenatal1Body3 extends LinearLayout implements
        IBaseAntenatal1Body {
    ...
    public Antenatal1Body3(Context context, AttributeSet attrs, int defStyle) {
        ...
        View rootView = LayoutInflater.from(context).inflate(
                R.layout.view_antenatal1_body3, this, true);
    ...
    public void getData(FollowUpFirstPregnancy followUpFirstPregnancy) {
        ...
        followUpFirstPregnancy.setTz_xy(et_xy_ssy.getText().toString() + "/"
    ...
    public void setData(FollowUpFirstPregnancy followUpFirstPregnancy) {
        if (followUpFirstPregnancy != null) {
            et_sg.setText(followUpFirstPregnancy.getTz_sg());
            et_tz.setText(followUpFirstPregnancy.getTz_tz());
            et_tzzs.setText(followUpFirstPregnancy.getTz_tzzs());
            String xy = followUpFirstPregnancy.getTz_xy();
