...
public class MentalDiseaseBody5 extends LinearLayout  implements IBaseMentalDiseaseBody{
	...
	public MentalDiseaseBody5(Context context, AttributeSet attrs, int defStyle) {
		...
		View rootView = LayoutInflater.from(context).inflate(R.layout.view_mental_disease_body5, this, true);
	...
	public void getData(FollowUpMentalDisease followUpMentalDisease) {
		...
		followUpMentalDisease.setHzdjtshdyx_gsqk(ViewDataUtil.getSpinnerData(sn_gsqk));
		followUpMentalDisease.setHzdjtshdyx_mccysj(et_mccysj.getText().toString());
		followUpMentalDisease.setHzdjtshdyx_zyqk(ViewDataUtil.getSpinnerData(sn_zyqk));
	}
