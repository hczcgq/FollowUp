...
public class Antenatal2_5Body6 extends LinearLayout  implements IBaseAntenatal2_5Body{
	...
	public void setData(FollowUpTwoToFivePregnancy followUpTwoToFivePregnancy) {
		if(followUpTwoToFivePregnancy!=null){
			et_jgjks.setText(followUpTwoToFivePregnancy.getZz_jgjks());
			et_yy.setText(followUpTwoToFivePregnancy.getZz_yy());
			et_xcsfrq.setText(followUpTwoToFivePregnancy.getZz_xcsfrq());
			et_sfysqm.setText(followUpTwoToFivePregnancy.getZtpg_sfysqm());
			
			if(followUpTwoToFivePregnancy.getZz_sfygzz()){
