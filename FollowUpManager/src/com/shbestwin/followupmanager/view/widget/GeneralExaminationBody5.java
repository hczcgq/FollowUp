...
public class GeneralExaminationBody5 extends LinearLayout implements IBaseGeneralExaminationBody{
	...
	public GeneralExaminationBody5(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		View rootView = LayoutInflater.from(context).inflate(R.layout.view_general_examination_body5, this, true);
	}
