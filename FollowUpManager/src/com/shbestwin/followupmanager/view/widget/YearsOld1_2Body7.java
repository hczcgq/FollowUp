...
public class YearsOld1_2Body7 extends LinearLayout  implements IBaseYearsOld1_2Body ,ListItemClickHelp{
	...
	public YearsOld1_2Body7(Context context) {
		this(context, null);
	}

	public YearsOld1_2Body7(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public YearsOld1_2Body7(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		View rootView = LayoutInflater.from(context).inflate(R.layout.view_years_old_1_2_body7, this, true);
