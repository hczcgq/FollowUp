...
public class AgednessBody4 extends LinearLayout implements IBaseAgednessBody {
    ...
    private RadioButton rb_smoking_w, rb_smoking_y, rb_drinking_w,
            rb_drinking_y, rb_sporting_w, rb_sporting_y;

    private EditText et_smoking, et_drinking, et_sporting_cz, et_sporting_fc,
            et_ydxm, et_syqk_dqz, et_syqk_mbz, et_mqqk, et_sffwnr, et_xcsfrq,
            et_sfysqm;
    ...
    public AgednessBody4(Context context, AttributeSet attrs, int defStyle) {
        ...
        View rootView = LayoutInflater.from(context).inflate(
                R.layout.view_agedness_body4, this, true);
    ...
    public void getData(FollowUpAged followUpAged) {
        ...
        followUpAged.setShfszd_sfyjms(ViewDataUtil.getSpinnerData(sn_drinking)
                + "/" + et_drinking.getText().toString());
        followUpAged.setShfszd_sfyd(isSporting);
        followUpAged.setShfszd_sfydms(et_sporting_cz.getText().toString() + "/"
                + et_sporting_fc.getText().toString());
        ...
        followUpAged.setShfszd_syqk(et_syqk_dqz.getText().toString() + "/"
