...
public class MentalDiseaseBody1 extends LinearLayout implements IBaseMentalDiseaseBody{
	...
	public MentalDiseaseBody1(Context context, AttributeSet attrs, int defStyle) {
		...
		View rootView = LayoutInflater.from(context).inflate(R.layout.view_mental_disease_body1, this, true);
