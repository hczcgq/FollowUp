...
public class YearsOld3_6Body4 extends LinearLayout implements
	...
	public YearsOld3_6Body4(Context context, AttributeSet attrs, int defStyle) {
		...
		View rootView = LayoutInflater.from(context).inflate(
				R.layout.view_years_old_3_6_body4, this, true);
	...
	public void getData(FollowUpThreeSixNewborn followUpThreeSixNewborn) {
		try {
			followUpThreeSixNewborn.setSysjc(JsonUtil
		...
		if (followUpThreeSixNewborn != null) {
			...
			try {
				List<LabInspection> lists = JsonUtil
						.jsonToObjects(followUpThreeSixNewborn.getSysjc(),
								LabInspection.class);
