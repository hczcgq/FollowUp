...
public class Antenatal1Fragment extends BaseFragment {
	...
	private void initData() {
		...
		if(followUpFirstPregnancy!=null){
			...
			if(numberNo.equals(followUpFirstPregnancy.getFollowUpNo())){
	...
	public void onSave() {
		...
		AccompanyManager.getInstance(getActivity()).addAccompany(followUpFirstPregnancy.getGrxx_tbrq(),followUpFirstPregnancy.getZz_xcsfrq(), Accompany.ACNO_ANTENATAL1);
	}
