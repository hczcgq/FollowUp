...
public class PhysiqueIdentifyFragment extends BaseFragment {
	...
	private TextView physiqueNameTextView, physiqueFeatureTextView, physiqueGuidanceTextView;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		View rootView = inflater.inflate(R.layout.fragment_examination_physique_identify, container, false);
		...
		physiqueReportButton = (Button) rootView.findViewById(R.id.physiqueReportButton);
		...
		physiqueBarChart = (BarChart) rootView.findViewById(R.id.physiqueBarChart);

		physiqueNameTextView = (TextView) rootView.findViewById(R.id.physiqueNameTextView);
		physiqueFeatureTextView = (TextView) rootView.findViewById(R.id.physiqueFeatureTextView);
		physiqueGuidanceTextView = (TextView) rootView.findViewById(R.id.physiqueGuidanceTextView);
	...
	public static final int[] VORDIPLOM_COLORS = { Color.parseColor("#FF6666"), Color.parseColor("#FF9966"), Color.parseColor("#FFCC00"), Color.parseColor("#CCCC33"), Color.parseColor("#009966"), Color.parseColor("#009999"),
			Color.parseColor("#3399CC"), Color.parseColor("#6666CC"), Color.parseColor("#663366") };
	...
	private void renderQuestion() {
		String[] options = getResources().getStringArray(R.array.PhysiqueOptions);
		List<Question> questions = ExaminationManager.getInstance(getActivity()).getPhysiqueQuestions();
		examinationLayout.renderView(null, getString(R.string.jktj_test_question_subtitle), questions, options);
	}
