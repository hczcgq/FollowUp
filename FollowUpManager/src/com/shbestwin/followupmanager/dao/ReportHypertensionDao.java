...
*/
public class ReportHypertensionDao extends AbstractDao<ReportHyoertension, String> {

    public static final String TABLENAME = "REPORT_HYPERTENSION";
    ...
    */
    ...
    public ReportHypertensionDao(DaoConfig config) {
        super(config);
    }
    
    public ReportHypertensionDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'REPORT_HYPERTENSION' (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "'REPORT_HYPERTENSION'";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, ReportHyoertension entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public ReportHyoertension readEntity(Cursor cursor, int offset) {
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, ReportHyoertension entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected String updateKeyAfterInsert(ReportHyoertension entity, long rowId) {
        return entity.getReportno();
    }
    
    /** @inheritdoc */
    @Override
    public String getKey(ReportHyoertension entity) {
        if(entity != null) {
            return entity.getReportno();
        } else {
            return null;
