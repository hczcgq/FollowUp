...
public class ReportDiabetesMellitusDao extends AbstractDao<ReportDiabetesMellitus, String> {
    ...
    public static final String TABLENAME = "REPORT_DIABETES_MELLITUS";
    ...
    */
    public static class Properties {
        public final static Property reportno = new Property(0, String.class, "reportno", true, "REPORT_NO");
        ...
        public final static Property marriy = new Property(8, String.class, "marriy", false, "MARRIY");
        ...
        public final static Property empty_bloodsuger = new Property(12, String.class, "empty_bloodsuger", false, "EMPTY_BLOODSUGER");
        public final static Property after_bloodsuger = new Property(13, String.class, "after_bloodsuger", false, "AFTER_BLOODSUGER");
        public final static Property rondam_bloodsuger = new Property(14, String.class, "rondam_bloodsuger", false, "RONDAM_BLOODSUGER");
        public final static Property experience = new Property(15, String.class, "experience", false, "EXPWRIENCE");
        public final static Property history_number = new Property(16, String.class, "history_number", false, "HISTORY_NUMBER");
        public final static Property history_msg = new Property(17, String.class, "history_msg", false, "HISTORY_MSG");
        public final static Property next_followup_date = new Property(18, String.class, "next_followup_date", false, "NEXT_FOLLOWUP_DATE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'REPORT_DIABETES_MELLITUS' (" + //
                ...
                "'REPORT_UNIT' TEXT," + 
                "'REPORT_DOCTOR' TEXT," + 
                "'EMPTY_BLOODSUGER' TEXT," + 
                "'AFTER_BLOODSUGER' TEXT," + 
                "'RONDAM_BLOODSUGER' TEXT," +
                "'EXPWRIENCE' TEXT," +
                "'HISTORY_NUMBER' TEXT," + 
                "'HISTORY_MSG' TEXT," + 
    ...
    protected void bindValues(SQLiteStatement stmt, ReportDiabetesMellitus entity) {
        ...
        String marriy = entity.getMarriy();
        if (marriy != null) {
            stmt.bindString(9, marriy);
        }
        ...
        String empty_bloodsuger = entity.getEmpty_bloodsuger();
        if (empty_bloodsuger != null) {
            stmt.bindString(13, empty_bloodsuger);
        }
        String after_bloodsuger = entity.getAfter_bloodsuger();
        if (after_bloodsuger != null) {
            stmt.bindString(14, after_bloodsuger);
        }
 
        String rondam_bloodsuger = entity.getRondam_bloodsuger();
        if (rondam_bloodsuger != null) {
            stmt.bindString(15, rondam_bloodsuger);
        }
 
        String experience = entity.getExperience();
        if (experience != null) {
            stmt.bindString(16, experience);
        }
        
        String history_number = entity.getHistory_number();
        if (history_number != null) {
            stmt.bindString(17, history_number);
        }
 
        String history_msg = entity.getHistory_msg();
        if (history_msg != null) {
            stmt.bindString(18, history_msg);
        }
 
        String next_followup_date = entity.getNext_followup_date();
        if (next_followup_date != null) {
            stmt.bindString(19, next_followup_date);
        }
    ...
    public void readEntity(Cursor cursor, ReportDiabetesMellitus entity, int offset) {
        ...
        entity.setMarriy(cursor.isNull(offset + 8) ? null : cursor.getString(offset + 8));
        ...
        entity.setEmpty_bloodsuger(cursor.isNull(offset + 12) ? null : cursor.getString(offset + 12));
        entity.setAfter_bloodsuger(cursor.isNull(offset + 13) ? null : cursor.getString(offset + 13));
        entity.setRondam_bloodsuger(cursor.isNull(offset + 14) ? null : cursor.getString(offset + 14));
        entity.setExperience(cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15));
        entity.setHistory_number(cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16));
        entity.setHistory_msg(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setNext_followup_date(cursor.isNull(offset + 28) ? null : cursor.getString(offset + 18));
